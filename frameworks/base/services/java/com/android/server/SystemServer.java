    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            try {
                ...
                ServiceManager.addService(Context.PBD_SERVICE, new PbdService(context));
            } catch (Throwable e) {
            ...
            /////////// DpaService Added //////////////////////////
            try {
                Slog.i(TAG, "Dpa Service");
                ServiceManager.addService(Context.DPA_SERVICE, new DpaService(context));
            } catch (Throwable e) {
                Slog.e(TAG, "Failure starting DpaService Service", e);
            } 
            //=======================================================================================
            // 
            //=======================================================================================
